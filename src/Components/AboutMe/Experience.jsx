...
import { FaLaptopCode, FaUserGraduate, FaProjectDiagram, FaCode } from "react-icons/fa";

// Experience Data
const experienceData = [
  {
    title: "Executive Frontend Developer",
    company: "Claystone Agency — A Concern of Betopia Limited",
    year: "2025 – Present",
    description:
      "Working as an Executive Frontend Developer, building and enhancing modern, responsive web applications while contributing to frontend architecture, UI development, and seamless user experiences using modern web technologies.",
    icon: <FaCode className="text-blue-500 w-8 h-8" />,
...
export default function Experience() {
  return (
    <section id="experience" className="py-20 backdrop-blur-sm backdrop-brightness-90">
      ...
      {/* Timeline Container */}
      <motion.div
        className="relative flex flex-col items-center px-6 md:px-10 lg:px-15 max-w-[1600px] mx-auto space-y-10"
      ...
      >
        ...
        {experienceData.map((exp, index) => (
          <motion.div
            key={index}
            className={`relative w-full md:w-[70%] bg-gray-100 rounded-xl shadow-md border-2 border-secondary p-6 flex flex-col md:flex-row items-center md:items-start gap-4 transition-transform duration-300 hover:shadow-xl hover:scale-[1.02] ${index % 2 === 0 ? "md:self-start" : "md:self-end"
              }`}
