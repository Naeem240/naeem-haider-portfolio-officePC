    ...
    return (
        <>
            ...
            <ul className='border-b pb-4 -mx-4 flex flex-col gap-2 menu-list text-lg justify-center'>
                ...
                <a target='_blank' href='https://drive.google.com/file/d/1sYJ4u1gmEw7Sj5VV_bzWYEQjZSsrxZvU/view' className='inline-flex items-center gap-2 cursor-pointer text-lg border py-1 px-4 rounded-lg text-black bg-[#f306f3] transition-all duration-1000 hover:bg-black hover:text-[#f306f3] mx-4 w-fit justify-center'>
                    <IoCodeDownload />
                    Resume
                </a>
            </ul>
